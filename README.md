...
- Every change should invoke `onChange` function with the changed widget's name and value together with all the other form data
...
- When user presses log-in button, current user info should appear using `UserPanel`, e.g. above the form
